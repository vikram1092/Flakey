...
struct Constants {
    ...
    static let baseChild = "scores"
    static let username = "username"
    static let score = "score"
    static let bestScore = "bestScore"
    static let highlightColor = #colorLiteral(red: 0.8274510503, green: 0.3294117451, blue: 0.2470588088, alpha: 1)
    static let secondaryColor = UIColor.gray
    
    
    static let moveFlakeTutorialText1 = "This is Flakey\n\nFlakey needs your help"
